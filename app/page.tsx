...
export default function Home() {
  return (
    <div className="relative flex items-center justify-center flex-col min-h-screen bg-white  group/design-root">
        ...
        <div className="@container">
          <div className="@[480px]:p-4">
            <div
              ...
              style={{
                backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://cdn.usegalileo.ai/sdxl10/99f30e5f-f372-4ffd-afe1-9817cb46431e.png")'
              }}
            >
              <h1
